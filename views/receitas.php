<div class="container bg-white px-4">
    <div class="row py-3 border-bottom">
        <div class="col-sm">
            <h6 class="card-title  mt-2 mb-0 text-pink"><i class="fas fa-file-invoice-dollar pr-2"></i>Relatório de Receitas</h6>        
        </div>  
    </div>
    <div class="row">
        ...
        <div class="col-12 pb-4">
            <button class="btn btn-sm px-3 btn-info">Buscar</button>
        </div>
    </div>
 </div>   