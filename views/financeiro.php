<div class="container bg-white px-4">
    <div class="row py-3 border-bottom">
        <div class="col-sm">
            <h6 class="card-title green mt-2 mb-0"><i class="fas fa-search-dollar pr-2 text-green-dark"></i>Contas a Receber</h6>
        </div>
        <div class="col-sm text-right">
            <a class="btn bg-pink text-white btn-sm font-8" data-toggle="modal" data-target="#novaConta"><i class="fas fa-plus pr-2"></i>Nova Conta</a>
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-12">
