<div class="container bg-white px-4">
    <div class="row py-3 border-bottom">
        ...
        <div class="col-sm text-right">
            <a href="http://localhost/Projetos/projeto-condominio/index.php?page=novoComunicado" class="btn btn-info btn-sm font-8"><i class="fas fa-plus pr-2"></i>Novo Comunicado</a>
        </div>
    </div>
    <div class="row my-4">
        <div class="col-12">
