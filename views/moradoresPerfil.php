            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 border-bottom pb-3 mb-3">
                        ...
                        <p class="text-cinza mb-1"><b>Apartamento:</b><span class="text-muted mb-1"> 201</span></p>            
                        <p class="text-cinza mb-1"><b>Bloco:</b> <span class="text-muted mb-1"> Unico</span></p>   
                        <p class="text-cinza mb-1"><b>Mora no Peredio:</b><span class="text-muted mb-1"> Não</span></p>  
                    </div>      
                </div>      
                <div class="row">   
                    <div class="col-12">
